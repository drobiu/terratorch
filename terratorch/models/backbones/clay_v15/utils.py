...
def posemb_sincos_2d(h, w, dim, temperature: int = 10000, dtype=torch.get_default_dtype()):
...
def posemb_sincos_1d(waves, dim, temperature: int = 10000, dtype=torch.get_default_dtype()):
